...
public class RegisterPage extends Utility {
    ...
    public void selectDateOfBirth() {
        clickOnElement(dateOfBirthDay);
        selectByValueFromDropDown(dateOfBirthDay,"17");
    }

    public void selectbirthmonth(){
        clickOnElement(dateOfBirthMonth);
        selectByValueFromDropDown(dateOfBirthMonth,"3");
    }

    public void selectbirthyear(){
        clickOnElement(dateOfBirthYear);
        selectByValueFromDropDown(dateOfBirthYear,"1998");
    }
